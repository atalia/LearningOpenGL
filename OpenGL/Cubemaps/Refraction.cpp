...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Refraction", NULL, NULL);
	if (window == NULL)
	{
		glfwTerminate();
		return -1;
	...
	Shader containShader("./Cubemaps/refract.vert", "./Cubemaps/refract.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(containShader.Program, "refraction"), 1.52f);
